/*
Dan, president of a large company could use your help. 
He wants to implement a system that will switch all of his 
devices into offline mode depending on his meeting schedule.

When he's at a meeting and somebody texts him, 
he wants to send an automatic message informing that he's
currently unavailable and the time when he's going to be back.
...
'currentTime' - is a string with specific time in hh:mm 24-h format 
for which the function will check availability based on the schedule.
...
If Dan is in the middle of an appointment at 'currentTime', 
the function should return a string with the time he's going to be available.
...
Note: You can expect only valid input.
*/
